...
#SBATCH --mem=170G
#SBATCH -o ../test_fisher_obc_mask/output_logs/output_run_%A_%a.txt
...
python3 -m test_per_sample_opacus.py --sparsity ${sparsity} --use_w_tilde ${use_w_tilde} --use_fisher_mask_with_true_grads ${use_fisher_mask_with_true_grads}
