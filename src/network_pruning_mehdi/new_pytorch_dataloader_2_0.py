...
from pytorch_dataset_2_0 import Dataset, IterableDataset
...
class Convertuint8(torch.nn.Module):
...
class _SingleProcessDataLoaderIter(_BaseDataLoaderIter):
    ...
    def _next_data(self):
        ...
        # self._dataset.data = self._dataset.data/1.0
        # self._dataset.convert_to_uint8 = True
        # self._dataset.transform_original = True
