...
# Gridsearch with no adaptive lr cosine
d_params = {}
d_params["learning_rate"] = [0.001, 0.005, 0.01, 0.05]
...
d_params["T_max_cos"] = [-1]
d_params["n_train_kept"] = [128]
d_params["patience"] = [10]
...
#d_params["val_second_lr"] = [0.01]
d_params["type_decay"] = ["cosine"]
