...
# Gridsearch with adaptive lr None
d_params = {}
d_params["learning_rate"] = [0.00005, 0.0001, 0.0005, 0.001]
...
d_params["test_one_layer_pruning"] = [1]
d_params["folder_saves"] = ["Saves_opt_dec_19"]
