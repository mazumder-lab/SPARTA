...
d_params["arch"] = ["resnet18"]
d_params["name_dataset"] = ["cifar100"]
d_params["n_epochs"] = [0]
d_params["T_max_cos"] = [200]
d_params["n_train_kept"] = [-1]
...
d_params["test_early_stopping"] = [0]
...
d_params["test_start_obc"] = [0]
d_params["test_start_convex"] = [1]
d_params["algo_pruning"] = ["obc_convex"]
d_params["rel_damp"] = [1e-2]
d_params["lambda_fisher"] = [1.0]
d_params["lambda_reconst"] = [1.0]
...
d_params["test_almost_sequential"] = [3]
d_params["tol_ent_reg"] = [1e-2]
d_params["tol_sel_reg"] = [1e-2]
d_params["n_incr_gradual_pruning"] = [-1]
d_params["goal_sparsity_discrete"] = [-1]
#d_params["type_pruning_schedule"] = ["linear", "exponential"]
d_params["folder_saves"] = ["Saves_resnet18_feb_9_2024"]
d_params["test_save_all_sparsities"] = [1]
d_params["n_parallel"] = [32]
d_params["n_convex"] = [-1]
d_params["pruning_level"] = ["layer"]
