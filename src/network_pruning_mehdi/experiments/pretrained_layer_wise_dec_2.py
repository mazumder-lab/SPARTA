...
d_params["l2_reg"] = [1e-4, 1e-3]
d_params["entropy_reg"] = [1e-4]
d_params["selection_reg"] = [1e-4]
...
d_params["pruning_rate_cte"] = [0.1, 0.05] # Add 0.05 maybe?
d_params["test_early_stopping"] = [1] # Add 0,2 maybe?
d_params["threshold_weights"] = [1500000]
d_params["lambda_loss"] = [1000.0]
...
d_params["folder_saves"] = ["Saves_opt_dec_2"]
