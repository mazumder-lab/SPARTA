...
d_params["arch"] = ["deit_base_patch16_224"]
...
d_params["goal_sparsity"] = [0.5, 0.6, 0.7, 0.8, 0.9]
...
d_params["lambda_fisher"] = [0.0, 0.1, 0.5, 1.0, 5, 10]
...
d_params["folder_saves"] = ["Saves_deit_jan_11_2024"]
d_params["device"] = ["cpu"]
