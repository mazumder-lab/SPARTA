...
import copy
from previous_utils.lr_schedules import cosine_lr_restarts, mfac_lr_schedule
...
model,train_dataset,test_dataset,criterion,modules_to_prune = model_factory(arch,name_dataset_path,pretrained=pretrained)
...
acc_different_methods = []
FOLDER = '{}/results/{}_{}_{}'.format(ROOT_PATH,arch,name_dataset,exp_name)
