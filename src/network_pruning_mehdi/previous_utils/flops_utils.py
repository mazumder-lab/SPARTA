...
def get_flops(dset,device, model):
    
    total_flops, module_flops, module_names = get_macs_dpf(dset,device, model, multiply_adds=False, ignore_zero=True,
                                                           display_log=True,
