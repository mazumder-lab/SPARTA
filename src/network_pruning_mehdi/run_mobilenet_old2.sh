...
srun /home/gridsan/gafriat/.conda/envs/additive/bin/python -u main.py --lr 0.005 --arch mobilenetv1 --name_dataset imagenet --optimizer_name Adam --selection_reg 0.1 --l2_reg 1e-03 --pretrained True --goal_sparsity 0.98 --folder_saves Saves_combined_pretrained_mlpnet_test --num_workers 40 --test_distributed 1
