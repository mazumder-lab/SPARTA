...
print(path_files)
l_columns = ["dataset", "model", "batch_size", "epsilon", "delta", "clipping", "warm_up", "classifier_lr", "lr", "sparsity", "epoch_mask_finding", "method_name", "use_last_layer_only_init", "seed", "Test acc"]
