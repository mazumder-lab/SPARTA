...
to_run = True
EXPERIMENT_DIR = "to_benchmark_deit_base_cif10"
...
l_seeds = [2024]
l_use_last_layer_only_init = [True]
    ...
    for seed in l_seeds:
        ...
        for sparsity in l_sparisities:
            ...
            for epoch_mask_finding in l_epoch_mask_finding:
                for use_last_layer_only_init in l_use_last_layer_only_init:
